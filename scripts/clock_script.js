...
const hourActiveColor = '#DB443A',
	minuteActiveColor = '#53322E',
	secondActiveColor = '#24AA7C';

// Define inactive colors for hour, minute and second hand
const hourInactiveColor = '#DAE2EB',
	minuteInactiveColor = '#EFF1F4',
	secondInactiveColor = '#DAE2EB';

const timerBg = '#EFF1F4';
...
function draw() {
	...
	drawText(`${hr.toString().padStart(2, "0")}:${min.toString().padStart(2, "0")} ${amOrPm}`, canvas.width / 2 - 60, canvas.height / 2 + 15, '#53322E', '28px');
